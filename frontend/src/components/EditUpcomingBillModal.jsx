...
export default function EditUpcomingBillModal({
  open,
  onClose,
  onSubmit,
  loading,
  ...
  useEffect(() => {
    if (bill) {
      setForm({
        ...
        next_execution_date: bill.next_execution_date
          ? bill.next_execution_date.slice(0, 10)
          : "",
        last_executed: bill.last_executed
          ? bill.last_executed.slice(0, 10)
          : "",
      });
    }
  }, [bill, open]);
