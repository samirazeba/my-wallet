...
export default function AddUpcomingBillModal({ open, onClose, onSubmit, loading, userId, defaultBankAccountId }) {
          ...
          <DialogPanel className="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            <div className="bg-white px-6 pt-6 pb-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <input name="next_execution_date" value={form.next_execution_date} onChange={handleChange} required placeholder="Next execution date" type="date" className="w-full border rounded p-2" />
                <input name="last_executed" value={form.last_executed} onChange={handleChange} type="date" className="w-full border rounded p-2" placeholder="Last Executed (optional)" />
